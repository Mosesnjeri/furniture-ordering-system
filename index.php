    ...
    <section class="furniture-search2 text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>furniture-search.php" method="POST">
                <input type="search" name="search" placeholder="Search furniture" required>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Various Furniture Categories</h2>
    ...
    <section class="furniture-menu">
        <div class="container">
            <h2 class="text-center">Our Furniture Menu</h2>

            <?php 
            
            //Getting Furniture from Database that are active and featured
            //SQL Query
            $sql2 = "SELECT * FROM tbl_furniture WHERE active='Yes' AND featured='Yes' LIMIT 6";
            ...
            //CHeck whether furniture available or not
            if($count2>0)
            {
                //Furniture Available
